...
from dataset import Chronos2Dataset, DatasetMode, TensorOrArray
...
class Chronos2Pipeline(BaseChronosPipeline):
    ...
    def predict(
        ...
        **kwargs,
        ...
        batch_size
            The batch_size used for prediction. Note that the batch size here means the number of time series, including target(s) and covariates,
            which are input into the model. If your data has multiple target and/or covariates, the effective number of time series tasks in a batch
            will be lower than this value, by default 256
        context_length
